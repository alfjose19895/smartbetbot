...
export function Footer() {
  ...
  if (isLandingPage) {
    badgeText = language === "en" ? "Direct Support & Sales" : "Asesoría & Adquisición";
    title =
      language === "en"
    ...
    btnText =
      language === "en"
        ...
        : "Adquirir por WhatsApp (+593 964082483)";
    defaultMessage =
      language === "en"
    ...
    badgeText = language === "en" ? "User Support & Helpdesk" : "Soporte Técnico & Ayuda";
    title =
      language === "en"
  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50 py-8 text-slate-600 transition-colors dark:border-slate-800/80 dark:bg-slate-950 dark:text-slate-400">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-6">
        {/* Support / Sales Callout Card */}
        <div className="rounded-3xl border border-slate-200 bg-white p-5 sm:p-6 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-3 py-0.5 text-xs font-black text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-500/30">
            <span>💬</span>
            <span>{badgeText}</span>
          </span>

          <h3 className="mt-2.5 text-sm sm:text-base font-black text-slate-900 dark:text-white max-w-xl mx-auto leading-snug">
            {title}
          </h3>

          <p className="mt-1 text-xs text-slate-600 dark:text-slate-400 max-w-lg mx-auto leading-relaxed">
            {subtitle}
          </p>
          ...
          <div className="mt-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-[#25D366] px-5 py-2.5 text-xs sm:text-sm font-extrabold text-white shadow-md shadow-emerald-500/20 transition-all hover:bg-[#20bd5a] hover:scale-105 active:scale-95 cursor-pointer"
            >
              <svg
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-slate-200 dark:border-slate-800/80 pt-4">
          <Link href="/" className="flex items-center gap-2">
            <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-tr from-emerald-500 to-cyan-500 text-[10px] font-black text-slate-950">
              ⚡
            </span>
          ...
          <nav className="flex flex-wrap items-center justify-center gap-3 text-xs font-semibold text-slate-600 dark:text-slate-400">
        ...
        {/* Legal Disclaimer */}
        <p className="text-[10px] text-center text-slate-500 dark:text-slate-500 max-w-xl mx-auto leading-relaxed">
          {language === "en"
