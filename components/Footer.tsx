...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-slate-200 bg-slate-50 py-8 text-slate-600 transition-colors dark:border-slate-800 dark:bg-slate-950 dark:text-slate-400">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 space-y-6">
        {/* Support / Sales Callout Box */}
        <div className="rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-md dark:border-slate-800 dark:bg-slate-900">
          <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-black text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400 border border-emerald-500/30">
            <span>💬</span>
            <span>{badgeText}</span>
          </div>
          ...
          <p className="mt-1.5 text-xs text-slate-600 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
            {subtitle}
          </p>
          ...
          <div className="mt-5 flex justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3.5 text-xs sm:text-sm font-black shadow-lg shadow-emerald-500/25 transition-all hover:opacity-95 hover:scale-105 active:scale-95 cursor-pointer no-underline"
            >
              <svg
